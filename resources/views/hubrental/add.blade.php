...
<script>
    ...
    var defaultLatitude = {{ request('latitude', config('leaflet.map_center_latitude', 51.505)) }};
    var defaultLongitude = {{ request('longitude', config('leaflet.map_center_longitude', -0.09)) }};
